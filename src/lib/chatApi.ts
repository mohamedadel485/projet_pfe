...
const CHAT_REQUEST_TIMEOUT_MESSAGE = 'Le chatbot met trop de temps a repondre. Reessaie dans un instant.';
...
const GENERIC_CHAT_ERROR_MESSAGE = 'Le chatbot rencontre une erreur temporaire. Reessaie dans un instant.';
const QUOTA_CHAT_ERROR_MESSAGE =
  'Quota Gemini atteint. Reessaie dans un moment ou verifie ton plan et ta facturation.';
const UNAVAILABLE_CHAT_ERROR_MESSAGE =
  'Le service Gemini est temporairement surcharge. Reessaie dans quelques instants.';
const API_KEY_CHAT_ERROR_MESSAGE =
  'La cle GEMINI_API_KEY (ou GOOGLE_API_KEY) est manquante ou invalide. Verifie la configuration du backend.';
