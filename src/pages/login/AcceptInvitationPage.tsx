          ...
          <form className="accept-invitation-form" onSubmit={handleSubmit}>
            ...
            {password && (
              <div className="password-strength">
                ...
                <ul>
                  <li className={hasMinLength ? 'valid' : ''}>Au moins 6 caractères</li>
                  <li className={hasUppercase ? 'valid' : ''}>Une lettre majuscule</li>
                  <li className={hasNumber ? 'valid' : ''}>Un chiffre</li>
                  <li className={hasSpecial ? 'valid' : ''}>Un caractère spécial</li>
                </ul>
              </div>
            )}
            ...
            {confirmPassword && password !== confirmPassword && (
              <p className="accept-invitation-field-error">Les mots de passe ne correspondent pas</p>
            )}
