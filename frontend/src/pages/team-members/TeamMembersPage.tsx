...
function TeamMembersPage({ onInviteTeam, summary }: TeamMembersPageProps) {
  return (
    <section className="team-members-page">
      <article className="team-members-card">
        ...
        {summary ? (
          <p className="team-members-kicker">
            {summary.users} users - {summary.pendingInvitations} invitations en attente
          </p>
        ) : null}
